...
import 'package:flutter_task/views/auth/signup/student_singup.dart';
import 'package:flutter_task/views/auth/signup/teacher_singup.dart';
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            Expanded(
              child: TabBarView(children: [StudentSingup(), TeacherSingup()]),
            ),
          ],
        ),
      ),
